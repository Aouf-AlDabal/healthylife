...
<html lang="en">
  ...
  <?php 
  include("include/headersingin.php");
...
?>
  <div class="signin-form">
	...
	<div class="text-center small" style='color: rgb(221, 26, 26);'>Back to signin?<a href="signin.php" style='color:#ffff;'>Click here</a></div>
</div>
</body>
</html>
<?php 
